...
' VARANJE:
'zdenka = nagrada
'zdenkas = supernagrada
'cicamica = supernagrada
'arijadne = lik Arijadne
'open = moguce otvoriti snimljenu igru
'rekord = promena rekorda
'sloboda = moguce upisati brojeve u 5 polja
'rnd = predvidljivo generisanje brojeva
'============================================
...
If ce = "open" Then opp.Enabled = True
...
Dim Ira As String, Gde As String
